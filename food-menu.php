...
<div class="menu-container">
				...
				<div class="food-menu">
					...
					<div class="food-name">
						<p class='description_content'><?php echo $row['name']; ?>
							<a href="javascript: void(0)" onclick="add_to_cart(<?php echo $row['id']; ?>)" class="cd-add-to-cart" data-price="<?php $row['price']; ?>"><br><button type="button" class="btn btn-primary add-tray">&#xf067; Add to Tray</button></a>
	...
	<script>
		...
		function add_to_cart(id){
			$.post('items-order-get.php', {id: id}, function(o){
				reloadCart();
			});
		}
